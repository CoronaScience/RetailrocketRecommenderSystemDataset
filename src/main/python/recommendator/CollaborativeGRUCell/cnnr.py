...
from recommendator.CollaborativeGRUCell import CollaborativeGRUCell
from recommendator.CollaborativeGRUCell import Dataset
...
def main(args):
    ...
    train_path= "/input/data/fakedata-train.txt"
    valid_path= "/input/data/fakedata-valid.txt"
